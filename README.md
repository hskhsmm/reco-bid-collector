...
ICT 인턴십의 기업상세정보를 보면 영업, 마케팅 등 업무 효율화를 위한 크롤링/스크래핑 서비스 개발이 프로젝트 내용에 기술되어 있습니다.<br>
따라서 프로젝트의 최종 사용자를 개발자가 아닌 영업/마케팅 등 비개발 직군으로 타겟팅했습니다.<br>
REST API만으로는 Postman이나 curl 없이 사용하기 어렵기 때문에, 브라우저만으로 크롤링 제어와 결과 확인이 가능한 웹 UI가 필요하다고 보았습니다.<br>
그래서 프로젝트를 구성한다면 이런 방식이 적절하겠다고 판단하여 UI를 함께 구현하게 되었습니다.
